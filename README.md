...
- Are there patterns indicating fraudulent loan applications or transactions?  
- How can executives monitor overall portfolio health effectively?  
...
## 🚀 Project Workflow  
1. Data cleaning and validation using SQL  
2. Exploratory analysis using Python  
3. Dashboard development in Power BI  

---

## 📌 Conclusion  
This project demonstrates how SQL, Python, and Power BI can be combined to build an end-to-end analytics solution for financial risk management.
